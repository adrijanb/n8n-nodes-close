        ...
        options: [
            {
                ...
                type: 'json',
                default: '[]',
                description: 'Array of opportunity status objects to include in the pipeline. Format: [{"id": "status_id"}] or [{"label": "New Status", "status_type": "active"}]',
    ...
    // Update Pipeline
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'json',
                default: '[]',
                description: 'Array of opportunity status objects. Use this to reorder statuses within the pipeline or move statuses from other pipelines. Format: [{"id": "status_id"}]',
